...
class Gamification
  ...
  # @return [Array]. Returns an Array with the data to persist in time.
  ...
  # @param short_description [String or Reward]. @return [TrueClass or FalseClass].
  ...
  # Creates a new reward. @param icon [String], @param short_description [String], @param long_description [String], @param available [TrueClass or FalseClass], @param cost [Fixnum]. @return [Reward].
  ...
  # @param reward [String or Reward]. @return [TrueClass or FalseClass]. Returns true if the item has been purchased, false otherwise.
  ...
  # @param reward [Reward], @param icon [String], @param short_description [String], @param long_description [String], @param available [TrueClass or FalseClass], @param cost [Fixnum].
  ...
  # @param reward [String or Reward]. @return [TrueClass or FalseClass]. *reward* is the short description of a reward. Returns true if succesfully deleted the reward, otherwise false.
