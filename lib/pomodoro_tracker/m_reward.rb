...
class Reward
  ...
  # @param icon [String], @param short_description [String], @param long_description [String], @param available [TrueClass or FalseClass], @param cost [Fixnum].
  ...
  # @param icon [String], @param short_description [String], @param long_description [String], @param available [TrueClass or FalseClass], @param cost [Fixnum]. Supposed to be called when the user edit the reward in any way. The GUI
  # system is responsible for making sure that the short_description doesn't crash with an existing one. That's the only requirement.
